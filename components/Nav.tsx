    ...
    >
      ...
      >
        <a
          ...
          aria-label="Character International Academy — back to top"
        >
        ...
        <button
          ...
          className="rounded-md p-1 md:hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-gold focus-visible:ring-offset-2 focus-visible:ring-offset-cream"
          onClick={() => setOpen((o) => !o)}
        >
